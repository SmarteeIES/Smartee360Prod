...
import za.smartee.support.task.GetAdvIntervalTask;
import za.smartee.support.task.GetAdvSlotDataTask;
import za.smartee.support.task.GetAdvTxPowerTask;
import za.smartee.support.task.GetBatteryTask;
import za.smartee.support.task.GetConnectableTask;
import za.smartee.support.task.GetDeviceTypeTask;
import za.smartee.support.task.GetFirmwareRevisionTask;
import za.smartee.support.task.GetHardwareRevisionTask;
import za.smartee.support.task.GetLockStateTask;
import za.smartee.support.task.GetManufacturerNameTask;
import za.smartee.support.task.GetModelNumberTask;
import za.smartee.support.task.GetRadioTxPowerTask;
import za.smartee.support.task.GetSerialNumberTask;
import za.smartee.support.task.GetSlotTypeTask;
import za.smartee.support.task.GetSoftwareRevisionTask;
import za.smartee.support.task.GetUnlockTask;
import za.smartee.support.task.ParamsTask;
import za.smartee.support.task.ResetDeviceTask;
import za.smartee.support.task.SetAdvIntervalTask;
import za.smartee.support.task.SetAdvSlotDataTask;
import za.smartee.support.task.SetAdvSlotTask;
import za.smartee.support.task.SetAdvTxPowerTask;
import za.smartee.support.task.SetConnectableTask;
import za.smartee.support.task.SetLockStateTask;
import za.smartee.support.task.SetRadioTxPowerTask;
import za.smartee.support.task.SetUnlockTask;
